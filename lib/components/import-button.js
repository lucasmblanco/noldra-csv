...
function ImportButton(props) {
    var variant = props.variant, label = props.label, clickImportButton = props.clickImportButton, onFileAdded = props.onFileAdded, onRef = props.onRef, chip = props.chip;
    ...
    return (react_1.default.createElement(material_1.Tooltip, { title: translate("csv.buttonMain.tooltip") },
        react_1.default.createElement("div", null,
            chip ? (react_1.default.createElement(Chip_1.default, { variant: "outlined", size: "small", color: "primary", label: label, onClick: clickImportButton, icon: react_1.default.createElement(GetApp_1.default, { style: { transform: "rotate(180deg)", fontSize: "20" } }) })) : (react_1.default.createElement(react_admin_1.Button, { color: "primary", component: "span", variant: variant, label: label, onClick: clickImportButton },
