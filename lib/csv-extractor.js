...
exports.processCsvDataAddError = exports.processCsvData = exports.getCsvData = exports.processCsvFile = void 0;
var papaparse_1 = require("papaparse");
var lensPath_js_1 = __importDefault(require("ramda/src/lensPath.js"));
var over_js_1 = __importDefault(require("ramda/src/over.js"));
var setObjectValue = function (object, path, value) {
    var lensPathFunction = (0, lensPath_js_1.default)((!!path ? path + "" : "").split("."));
    return (0, over_js_1.default)(lensPathFunction, function () { return value; }, object || {});
};
function processCsvFile(file, parseConfig) {
    if (parseConfig === void 0) { parseConfig = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var csvData, csvDataProcessed;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    csvData = _a.sent();
                    csvDataProcessed = processCsvData(csvData);
                    return [2 /*return*/, [csvDataProcessed, csvData]];
            }
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    return (0, papaparse_1.parse)(file, __assign(__assign({ 
                        // Defaults
...
function processCsvDataAddError(data) {
    if (Array.isArray(data[0])) {
        var topRowKeys_2 = data[0];
        var dataRows = data.slice(1).map(function (row) {
            var value = {};
            topRowKeys_2.forEach(function (key, index) {
                value = setObjectValue(value, key, row[index]);
            });
            return value;
        });
        ...
        data.forEach(function (obj) {
            ...
            for (var key in obj)
                value = setObjectValue(value, key, obj[key]);
            dataRows_2.push(value);
        });
        return dataRows_2;
    }
}
exports.processCsvDataAddError = processCsvDataAddError;
