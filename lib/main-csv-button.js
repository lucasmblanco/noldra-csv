...
var MainCsvImport = function (props) {
    ...
    var resource = props.resource || (0, react_admin_1.useResourceContext)();
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 7:
                            ...
                            return [4 /*yield*/, (0, import_controller_1.GetIdsColliding)(logging, translate, dataProvider, csvNew, resourceName, disableGetMany)];
                        case 8:
    ...
    function createRows(vals, csvItems) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, uploader_1.create)(logging, disableCreateMany, dataProvider, resourceName, vals, preCommitCallback, postCommitCallback, file, parseConfig, csvItems)];
            });
        });
    }
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(import_button_1.ImportButton, { variant: variant, label: label, clickImportButton: clickImportButton, onFileAdded: onFileAdded, onRef: function (ref) { return (refInput = ref); }, chip: chip }),
