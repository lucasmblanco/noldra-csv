                ...
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(values.map(function (value, i) {
                            if (value.errors) {
                                ...
                                var Tags_1 = value.Tags, Properties_1 = value.Properties, cleanValue = __rest(value, ["Tags", "Properties"]);
                                var processedValue = dataProvider
                                    .create(resource, { data: cleanValue })
                                    .then(function (res) { return __awaiter(_this, void 0, void 0, function () {
                                    var ogData, valueResult, _a, _b;
                                    return __generator(this, function (_c) {
                                        switch (_c.label) {
                                            case 0:
                                                ogData = csvItems === null || csvItems === void 0 ? void 0 : csvItems[i];
