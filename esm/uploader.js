            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(values.map(function (value, i) {
                                    ...
                                    return __generator(this, function (_c) {
                                        switch (_c.label) {
                                            case 0:
                                                ...
                                                return [4 /*yield*/, Promise.all(Tags_1.map(function (id) { return __awaiter(_this, void 0, void 0, function () {
                                                        var createdTag, err_1;
                                                        return __generator(this, function (_a) {
                                                            switch (_a.label) {
                                                                case 0:
                                                                    _a.trys.push([0, 2, , 3]);
                                            ...
                                            case 2:
                                                ...
                                                return [4 /*yield*/, Promise.all(Properties_1.map(function (property) { return __awaiter(_this, void 0, void 0, function () {
                                                        var createdProperty, err_2;
                                                        return __generator(this, function (_a) {
                                                            switch (_a.label) {
                                                                case 0:
                                                                    _a.trys.push([0, 2, , 3]);
                                                                ...
                                                                case 2:
                                                                    err_2 = _a.sent();
                                                                    console.error("Error creating property:", err_2);
                                                                    return [2 /*return*/, { success: false }];
                                                                case 3: return [2 /*return*/];
                                                            }
                                                        });
                            ...
                            return unparse(res.map(function (res) { return res.value; }));
                        })];
                case 1:
                    csvData = _a.sent();
