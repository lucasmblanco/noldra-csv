...
export var creationSummary = function (values, attribute) {
            ...
            switch (_a.label) {
                                    ...
                                    return [4 /*yield*/, Promise.all(chunkedValues.map(function (value, i) { return __awaiter(_this, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_e) {
                                                switch (_e.label) {
                                                    ...
                                                    case 4:
                                                        _c.Tag = _e.sent();
                                                        itemData["Tag status"] = creationSummary(valueResult.attributes.Tag, "tags");
                                                        _e.label = 5;
                                                    case 5:
                                                    ...
                                                    case 6:
                                                        ...
                                                        itemData["Properties status"] = creationSummary(valueResult.attributes.Properties, "properties");
                                                        _e.label = 7;
                ...
                case 4:
                    try {
                        ...
                        return [2 /*return*/, [reportItems, unparse(csvDataFinal.map(function (data) { return data.value; }))]];
                    }
                    catch (err) {
...
function createInDataProviderFallbackWithPooling(dataProvider, resource, values, csvItems) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            try {
                reportItems.push.apply(reportItems, csvDataFinal);
                return [2 /*return*/, [reportItems, unparse(csvDataFinal)]];
            }
            catch (err) {
                console.error("Error parsing data:", err);
                return [2 /*return*/, [reportItems, []]];
